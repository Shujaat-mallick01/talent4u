/**
 * The TALENT4U primary lockup (BRANDGUIDE): the dotted orbit in Signal Red —
 * Ember in dark mode via the --primary token — and the wordmark in
 * currentColor. Inlined so it costs no request and inherits the theme.
 */
export function Logo({ className }: { className?: string }) {
  return (
    ...
    >
      <g fill="var(--primary)">
        <circle cx="-170" cy="-95.4" r="8.4" />
        <circle cx="-172.3" cy="-130.3" r="14.1" />
        <circle cx="-130.5" cy="-162.3" r="25.5" />
        <circle cx="-66.3" cy="-160.1" r="18.1" />
        <circle cx="-13.2" cy="-141.9" r="14.2" />
        <circle cx="25.9" cy="-121.9" r="8.1" />
        <circle cx="53.3" cy="-106.4" r="5.5" />
        <circle cx="74.8" cy="-90.4" r="4.8" />
        <circle cx="170" cy="95.4" r="8.4" />
        <circle cx="172.3" cy="130.3" r="14.1" />
        <circle cx="130.5" cy="162.3" r="25.5" />
        <circle cx="66.3" cy="160.1" r="18.1" />
